...
<div class="navbar navbar-inverse navbar-extra" >
     ...
     <div class="container">
  <form class="form-signin" method="POST" action="/cookzilla/rsvp2.php">
    <h3 class="form-signin-heading">RSVP Group Event</h3>
    <hr>
    <input type="hidden" name="csrfmiddlewaretoken" value="ATJpOoTKlFZIZKALOpdr6BvmjWuLNmECMKelyt0vqOt93EPBkPydgpa0nwoLg8uZ">
    <div  id = "profile"><input id="profile" name="eid" placeholder="EventID" type="number" required="" class="form-control"></div>
